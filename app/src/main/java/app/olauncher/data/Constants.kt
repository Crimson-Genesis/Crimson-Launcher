...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val URL_ABOUT_OLAUNCHER = "https://github.com/crimson-genesis"
    const val URL_OLAUNCHER_PRIVACY = "https://github.com/crimson-genesis"
    const val URL_DOUBLE_TAP = "https://github.com/crimson-genesis"
    const val URL_OLAUNCHER_GITHUB = "https://github.com/crimson-genesis"
    const val URL_INSTAGRAM_CRIMSON = "https://www.instagram.com/crims0n_genesis"
    const val URL_TWITTER_CRIMSON = "https://www.instagram.com/crims0n_genesis"
    const val URL_DUCK_SEARCH = "https://duck.co/?q="
    const val URL_DIGITAL_WELLBEING_LEARN_MORE = "https://www.linkedin.com/in/crimson-genesis/"
